  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute left-[-5%] bottom-[-5%] w-[300px] h-[300px] bg-brand-blue opacity-20 rounded-full blur-3xl" />
        <div className="absolute right-[-5%] bottom-[-5%] w-[250px] h-[250px] bg-brand-blue-light opacity-15 rounded-full blur-3xl" />
      </div>
