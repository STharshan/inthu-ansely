        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="lg:sticky lg:top-8">
              {/* Table of Contents */}
              <div className="mb-12">
                <p className="text-sm font-medium mb-4 text-gray-900">Table of contents</p>
              ...
              {/* Share Section */}
              <div>
                <p className="text-sm font-bold mb-3">Share</p>
          ...
          <div className="lg:col-span-9">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 leading-tight" id="header-0">
              ...
              <h3 className="text-xl md:text-2xl font-bold mt-12 mb-4" id="header-1">
                Why It Matters
              </h3>
              ...
              <h3 className="text-xl md:text-2xl font-bold mt-12 mb-4" id="header-2">
              ...
              <h3 className="text-xl md:text-2xl font-bold mt-12 mb-4" id="header-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold mt-12 mb-4" id="header-4">
                Getting Started
              </h3>

              <p className="text-gray-700 mb-6 leading-relaxed">
                Roles & Permissions is available today for all Vectura users. You can find it in <strong>Settings → Team</strong>, where you'll be able to assign default roles or create custom ones based on your company's needs.
              </p>
