...
const CourseCard = ({ module, onClick }) => {
  // 1. Assign the icon component to a Capitalized variable
  ...
  return (
    ...
    >
      ...
      <div className={`h-32 bg-gradient-to-br ${module.gradient} p-6 relative`}>
        {/* 2. Render the Icon as a component inside the span */}
        <span className="absolute bottom-[-20px] right-6 bg-white dark:bg-zinc-800 p-3 rounded-2xl shadow-lg group-hover:scale-110 transition-transform flex items-center justify-center">
          <Icon size={32} className="text-zinc-800 dark:text-white" />
        </span>
      ...
      <div className="p-8 pt-10 flex flex-col flex-grow">
        ...
        <div className="mt-8 flex items-center text-[#0045EF] font-bold text-xs tracking-widest uppercase group cursor-pointer">
          Start Learning
          <ArrowRight
