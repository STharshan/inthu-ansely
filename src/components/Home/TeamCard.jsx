...
export default function TeamCarousel() {
    ...
    return (
        <div className="min-h-screen bg-[#2b2d31] text-white font-sans">

            {/* Main container */}
            <div className="flex items-center justify-center min-h-screen p-8">
                <div className="w-full max-w-[1600px] rounded-lg overflow-hidden">
                    <div className="grid  grid-cols-[7fr_5fr_2fr] gap-2">
                        {/* Left Section */}
                        ...
                        <div className=" flex flex-col">
                            {/* Top - Navigation */}
                            <div className="flex justify-center border-[#404247]">
