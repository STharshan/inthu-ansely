    ...
    <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div key={idx}>
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 hover:shadow-lg transition-all">
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 rounded-full bg-[#0045EF]/10 dark:bg-[#0045EF]/20 flex items-center justify-center">
              ...
              {idx < funnelSteps.length - 1 && (
                <div className="flex justify-center py-3">
                  <ArrowDown className="h-6 w-6 text-[#0045EF]" />
                </div>
              )}
            </div>
          );
      ...
      <div className="bg-[#0045EF]/10 dark:bg-[#0045EF]/20 rounded-xl border-2 border-[#0045EF]/20 shadow-sm p-8">
        <div className="flex items-start gap-4">
          <TriangleAlert className="h-8 w-8 text-[#0045EF] flex-shrink-0 mt-1" />
          <div>
        ...
        <ul className="space-y-3">
          {[
            ...
            <li key={i} className="flex items-start gap-3">
              <span className="w-2 h-2 rounded-full bg-[#0045EF] mt-2" />
      ...
      {/* Footer Highlight */}
      <div className="bg-[#0045EF] text-white rounded-xl shadow-sm p-6">
