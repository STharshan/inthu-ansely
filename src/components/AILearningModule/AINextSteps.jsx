  ...
  return (
    <div className="prose max-w-none space-y-8 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-[#0045EF]">Your Next Steps</h3>
          ...
          {steps.map((item, idx) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-[#0045EF] text-white rounded-lg flex items-center justify-center font-bold flex-shrink-0">
                  {idx + 1}
                </div>
      ...
      <div className="bg-[#0045EF] text-white rounded-xl p-8 text-center">
      ...
      <div className="bg-[#0045EF]/10 border border-[#0045EF]/20 rounded-xl p-6 text-center transition-colors duration-300">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0045EF]/20 text-[#0045EF] rounded-full mb-4">
