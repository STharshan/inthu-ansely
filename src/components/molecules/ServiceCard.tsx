      ...
      <div className="opacity-100">
        ...
        <div className="opacity-100 flex items-center gap-4 mb-4">
          <div className="w-6 h-6 flex items-center justify-center">
            <Icon className="text-gray-900 dark:text-white opacity-100 transition-colors duration-300" size={24} />
          </div>
          <h4 className="text-gray-900 dark:text-white font-semibold text-lg transition-colors duration-300">{card.title}</h4>
        </div>
