...
const SEOLesson1 = ({ onBackToModules, onLessonComplete }) => {
    ...
    const goToNext = () => {
        ...
        if (currentLessonIndex < totalLessons - 1) {
            ...
            // Last lesson completed - redirect to all modules
            if (onBackToModules) {
                onBackToModules();
            }
        }
                    ...
                    <div className="flex items-center justify-between mb-3 gap-4">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                            <button 
                                ...
                                className="inline-flex items-center justify-center hover:bg-slate-100 h-8 sm:h-9 rounded-md px-2 sm:px-3 text-sm font-medium text-slate-700 transition-colors flex-shrink-0"
                            >
                                <Home className="h-4 w-4 sm:mr-2" />
                                <span className="hidden sm:inline">All Modules</span>
                            </button>

                            <div className="h-4 w-px bg-slate-300 flex-shrink-0"></div>

                            <div className="min-w-0">
                                <div className="text-xs text-slate-500">Module 1</div>
                        ...
                        <span className="inline-flex items-center justify-center rounded-md border border-slate-200 bg-slate-100 text-slate-700 font-medium px-2 sm:px-3 py-1 text-xs sm:text-sm whitespace-nowrap flex-shrink-0">
            ...
            `}
                    >
                      ...
                      `}
                                        >
                                            {isCompleted ? (
                                                <CheckCircle2 className={`h-4 w-4 flex-shrink-0 ${isActive ? 'text-white' : 'text-green-600'}`} />
                                            ) : (
                                                <Circle className={`h-4 w-4 flex-shrink-0 ${isActive ? 'text-white' : 'text-slate-400'}`} />
                                            )}
                    ...
                    <main>
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8">
                            ...
                            <div className="mb-6 sm:mb-8">
                                <span className="inline-flex items-center justify-center rounded-md border border-blue-600 bg-blue-600 text-white px-3 py-1 text-xs font-medium mb-3">
                            ...
                            <div className="prose prose-slate max-w-none">
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 p-5 rounded-lg">
                                        <h4 className="font-semibold mb-3 text-blue-900">Examples:</h4>
                                    ...
                                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-5 rounded-lg">
                                        <p className="text-base sm:text-lg font-semibold text-center text-slate-900">
                            ...
                            {/* Navigation Buttons */}
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 mt-8 pt-6 border-t border-slate-200">
                                <button
                  ...
                  `}
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-10 px-4 bg-blue-600 hover:bg-blue-700 text-white shadow-sm"
                                >
                        ...
                        {completedCount === totalLessons && (
                            <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <button
                                    onClick={handleBackToModules}
                                    className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white h-10 rounded-md px-6 text-sm font-medium transition-colors shadow-sm"
                                >
                                    Back to All Modules
                                </button>
                            </div>
