    ...
    <section className="bg-white dark:bg-black py-32 px-6 transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl px-8 py-10 flex flex-col justify-center transition-colors duration-500">
                ...
                <h4 className="text-[var(--brand-blue)] font-semibold mb-4">
                  {service.subtitle}
                </h4>
        ...
        <div className="mt-20 text-center">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-3 px-8 py-4 rounded-lg bg-[var(--brand-blue)] text-white
                       font-semibold transform transition-all duration-300 shadow-lg
                       hover:scale-105 hover:shadow-xl"
          >
            Get Started
            <span className="bg-white text-[var(--brand-blue)] w-8 h-8 flex items-center justify-center rounded-full text-lg transition-transform duration-300">
              →
            </span>
          </a>
        </div>
