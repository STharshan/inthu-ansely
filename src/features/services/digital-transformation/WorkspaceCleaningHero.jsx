      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a
              href="/services"
              className="group relative px-8 py-4 rounded-lg border-2 border-[var(--brand-blue)] text-[var(--brand-blue)]
                         font-medium overflow-hidden
                         before:absolute before:inset-0 before:bg-[var(--brand-blue)] before:scale-x-0 before:origin-left
            ...
            <a
              href="/contact"
              className="group px-8 py-4 rounded-lg bg-[var(--brand-blue)] text-white
                         font-semibold flex items-center justify-center gap-3
                         transform transition-all duration-300 shadow-lg
                         hover:scale-105 hover:shadow-xl"
            >
              Get Started
              <span className="bg-white text-[var(--brand-blue)] w-8 h-8 flex items-center justify-center rounded-full text-lg transition-transform duration-300 group-hover:translate-x-1">
                →
              </span>
            </a>
          </div>
