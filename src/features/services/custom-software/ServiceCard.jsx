    ...
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        <div className="absolute inset-0 rounded-2xl opacity-100">
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[var(--brand-blue)] via-blue-400 to-[var(--brand-blue)] animate-[spin_3s_linear_infinite] blur-md" />
        </div>
        ...
        <div className="relative z-30 w-full h-full flex items-center justify-center">
          <div className="absolute w-20 h-20 rounded-full bg-[var(--brand-blue)]/25 transition-all duration-700" />

          <Icon
            size={50}
            className="relative z-10 text-[var(--brand-blue)] transition-all duration-700"
            style={{
