      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-5">
            <div className="bg-[var(--brand-blue)] rounded-full w-10 h-10 flex items-center justify-center shadow-lg">
              <svg
            ...
            <span className="text-sm font-medium text-[var(--brand-blue)]">How We Work</span>
          </div>
            ...
            {processes.map((process, index) => (
              ...
              >
                ...
                <div className="flex-shrink-0">
                  <div className="bg-[var(--brand-blue)] rounded-full w-10 h-10 flex items-center justify-center shadow-md">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 256 256"
                      className="w-4 h-4"
