  ...
  return (
    <div className="prose max-w-none space-y-8 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-[var(--brand-blue)]">Your Next Steps</h3>
          ...
          {steps.map((item, idx) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-[var(--brand-blue)] text-white rounded-lg flex items-center justify-center font-bold flex-shrink-0">
                  {idx + 1}
                </div>
      ...
      <div className="bg-[var(--brand-blue)] text-white rounded-xl p-8 text-center">
      ...
      <div className="bg-[var(--brand-blue)]/10 border border-[var(--brand-blue)]/20 rounded-xl p-6 text-center transition-colors duration-300">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--brand-blue)]/20 text-[var(--brand-blue)] rounded-full mb-4">
