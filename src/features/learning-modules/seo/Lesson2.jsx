                    ...
                    comparison: [
                        {
                            ...
                            textClass: "text-[var(--brand-blue)] ",
                            descClass: "text-[var(--brand-blue)] "
                        },
                        {
                    ...
                    <main>
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-slate-200 dark:border-gray-800 shadow-sm p-6 sm:p-8">
                            ...
                            <div className="prose dark:prose-invert max-w-none space-y-6">
                                ...
                                <div className=" border border-purple-200 dark:border-[var(--brand-blue)] p-5 rounded-lg text-center">
