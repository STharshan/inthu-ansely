                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="w-full bg-slate-200 dark:bg-gray-700 rounded-full h-1.5 mt-3">
                        <div
                          className="bg-[var(--brand-blue)] h-full transition-all duration-500 rounded-full"
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-2 sm:gap-3">
                    <button
                      ...
                      className="inline-flex items-center justify-center bg-[var(--brand-blue)] text-white hover:bg-blue-700 h-9 rounded-md px-3 sm:px-4 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                    >
                      Start Module
