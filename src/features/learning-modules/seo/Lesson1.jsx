            ...
            `}
                    ...
                    <main>
                        <div className="bg-white dark:bg-gray-900 rounded-xl border border-slate-200 dark:border-gray-800 shadow-sm p-6 sm:p-8">
                            ...
                            <div className="mb-6 sm:mb-8">
                                <span className="inline-flex items-center justify-center rounded-md border border-[var(--brand-blue)] bg-[var(--brand-blue)] text-white px-3 py-1 text-xs font-medium mb-3">
                  ...
                  `}
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-10 px-4 bg-[var(--brand-blue)] hover:bg-blue-700 text-white shadow-sm"
                                >
                        ...
                        {completedCount === totalLessons && (
                            <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-2 border-green-200 dark:border-green-800 rounded-xl p-6 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <button
                                    onClick={handleBackToModules}
                                    className="inline-flex items-center justify-center bg-[var(--brand-blue)] hover:bg-blue-700 text-white h-10 rounded-md px-6 text-sm font-medium transition-colors shadow-sm"
                                >
                                    Back to All Modules
                                </button>
                            </div>
