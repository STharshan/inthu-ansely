...
const PPCvsOrganic = () => {
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <table className="w-full min-w-[700px]">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                ...
                <th className="text-left p-4 font-semibold text-gray-900 dark:text-white">
                  <div className="flex items-center gap-2">
                    <Target className="h-4 w-4 text-[var(--brand-blue)]" />
                    Control
                  </div>
                </th>
              </tr>
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
                ...
                <td className="p-4 text-[var(--brand-blue)] font-semibold">Low</td>
                <td className="p-4 text-[var(--brand-blue)] font-semibold">Long-term</td>
              ...
              {/* Paid Ads */}
              <tr className="bg-[var(--brand-blue)]/10 dark:bg-[var(--brand-blue)]/20 hover:bg-[var(--brand-blue)]/20 dark:hover:bg-[var(--brand-blue)]/30 transition-colors">
                <td className="p-4 font-bold text-gray-900 dark:text-white">Paid Ads</td>
                <td className="p-4">
                  <span className="text-[var(--brand-blue)] font-semibold flex items-center gap-1">
                ...
                <td className="p-4 text-[var(--brand-blue)] font-semibold">High</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* Conclusion */}
      <div className="bg-[var(--brand-blue)]/10 dark:bg-[var(--brand-blue)]/20 rounded-xl shadow-sm p-6 border border-[var(--brand-blue)]/20">
