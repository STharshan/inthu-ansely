    ...
    <div className="space-y-8 animate-in fade-in duration-500">
          ...
          return (
            <button
              ...
              className={`p-4 rounded-lg border-2 text-left transition-all dark:border-gray-700 ${
                isActive
                  ? "border-[var(--brand-blue)] bg-[var(--brand-blue)]/10 shadow-md scale-105"
                  : "border-gray-200 hover:border-[var(--brand-blue)] dark:bg-gray-800 dark:hover:border-[var(--brand-blue)]"
              }`}
            >
              <Icon
                className={`h-6 w-6 mb-2 ${
                  isActive ? "text-[var(--brand-blue)]" : "text-gray-400 dark:text-gray-500"
                }`}
              />
              <div
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 animate-in fade-in duration-300">
        <div className="flex items-start gap-6">
          <div className="p-4 rounded-xl bg-[var(--brand-blue)]/10 dark:bg-[var(--brand-blue)]/20">
            <ActiveIcon className="h-12 w-12 text-[var(--brand-blue)]" />
          </div>
      ...
      <div className="bg-[var(--brand-blue)]/10 dark:bg-[var(--brand-blue)]/20 rounded-xl border-2 border-[var(--brand-blue)]/20 shadow-sm p-8">
        <p className="text-xl font-semibold text-center text-[var(--brand-blue)] dark:text-[var(--brand-blue)]">
