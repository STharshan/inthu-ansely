...
const PPCMistakes = () => {
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-br from-[var(--brand-blue)]/10 to-[var(--brand-blue)]/20 dark:from-[var(--brand-blue)]/20 dark:to-[var(--brand-blue)]/10 rounded-xl shadow-sm p-8 border-2 border-[var(--brand-blue)]/30 dark:border-[var(--brand-blue)]/50">
        ...
        <ul className="space-y-2">
          {requirements.map((item, i) => (
            <li key={i} className="flex items-center gap-2 text-gray-800 dark:text-gray-200">
              <div className="w-2 h-2 rounded-full bg-[var(--brand-blue)]"></div>
              <span>{item}</span>
            </li>
          ))}
        </ul>
