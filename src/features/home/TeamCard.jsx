        ...
        <div className="rounded-lg w-full">
          ...
          <div className="hidden lg:grid lg:grid-cols-[7fr_5fr_2fr] gap-2">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <div
                  className={`flex items-center rounded-xl p-10 justify-between mb-1 ${
                ...
                <div
                  className={`rounded-xl p-10 h-120 ${isDarkMode ? "bg-gray-800" : "bg-gray-100"}`}
                >
                  <h2
            ...
            <div
              className={`rounded-lg flex items-center justify-center p-8 ${
            ...
            <div className="flex flex-col">
              <div className="flex justify-center">
                <div
                  className={`flex gap-6 p-10 rounded-xl ${
                    isDarkMode ? "bg-gray-800" : "bg-gray-100"
                  }`}
                >
                  <button
                  ...
                  >
                    <ChevronLeft className="w-6 h-6 text-[var(--brand-blue)]" />
                  </button>
                  <button
                    onClick={next}
                    className={`w-12 h-12 rounded-lg border flex items-center justify-center transition-colors ${
                  ...
                  >
                    <ChevronRight className="w-6 h-6 text-[var(--brand-blue)]" />
                  </button>
                </div>
              </div>

              <div
                className={`flex-1 flex items-center justify-center mt-1 rounded-xl p-10 ${
                  isDarkMode ? "bg-gray-800" : "bg-gray-100"
                }`}
              >
                <div className="flex flex-col gap-6">
                  <button
                    className={`w-12 h-12 rounded-lg border flex items-center justify-center transition-colors ${
                      isDarkMode
                        ? "border-gray-600 hover:bg-gray-700 text-gray-400 hover:text-[var(--brand-blue)]"
                        : "border-gray-300 hover:bg-gray-200 text-gray-600 hover:text-[var(--brand-blue)]"
                    }`}
                  >
          ...
          <div className="lg:hidden flex flex-col gap-3">
            ...
            <div
              className={`flex items-center rounded-xl p-4 sm:p-6 justify-between ${
                isDarkMode ? "bg-gray-800" : "bg-gray-100"
              }`}
            >
              <span
            ...
            >
              <div className="flex gap-4">
                ...
                >
                  <ChevronLeft className="w-5 h-5 sm:w-6 sm:h-6 text-[var(--brand-blue)]" />
                </button>
                <button
                  onClick={next}
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg border flex items-center justify-center transition-colors ${
                ...
                >
                  <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6 text-[var(--brand-blue)]" />
                </button>
              </div>
            </div>

            {/* Image */}
            <div className={`rounded-xl p-4 sm:p-6 ${isDarkMode ? "bg-gray-900" : "bg-gray-200"}`}>
            ...
            >
              ...
              <p
                className={`text-base sm:text-lg md:text-xl font-semibold mb-4 sm:mb-6 ${
                  isDarkMode ? "text-gray-400" : "text-gray-600"
                }`}
              >
                {current.title}
