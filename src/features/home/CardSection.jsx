      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className={`absolute top-20 left-10 w-64 h-64 rounded-full blur-3xl animate-float ${
            isDarkMode ? 'bg-[var(--brand-blue)]/5' : 'bg-[var(--brand-blue)]/10'
          }`}></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 ${
              ...
              Our <span className="text-[var(--brand-blue)]">Services</span>
            </h2>
                ...
                <SwiperSlide key={index}>
                  <div
                    className={`group rounded-2xl shadow-2xl backdrop-blur-sm p-6 sm:p-8 flex flex-col transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2 ${
                      isDarkMode 
                        ? 'bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 hover:border-[var(--brand-blue)]/50 hover:shadow-[0_0_30px_rgba(0,69,239,0.3)]'
                        : 'bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 hover:border-[var(--brand-blue)]/50 hover:shadow-[0_0_30px_rgba(0,69,239,0.2)]'
                    }`}
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ${
                        isDarkMode
                          ? 'bg-gradient-to-br from-[var(--brand-blue)]/20 to-[var(--brand-blue)]/5 border border-[var(--brand-blue)]/30'
                          : 'bg-gradient-to-br from-[var(--brand-blue)]/10 to-[var(--brand-blue)]/5 border border-[var(--brand-blue)]/20'
                      }`}>
                        <Icon
                          size={28}
                          className="text-[var(--brand-blue)] group-hover:rotate-12 transition-transform duration-300"
                        />
                      </div>
                    ...
                    {/* Title & Subtitle */}
                    <div className="mb-6">
                      <h3 className={`text-xl sm:text-2xl font-bold mb-2 group-hover:text-[var(--brand-blue)] transition-colors duration-300 ${
                        isDarkMode ? 'text-white' : 'text-gray-900'
                      }`}>
                        {item.title}
                      </h3>
                      <p className="text-xs sm:text-sm text-[var(--brand-blue)] font-medium tracking-wide">
                        {item.subtitle}
                      </p>
                    </div>
                    ...
                    <div className={`rounded-xl p-4 sm:p-6 mb-6 h-40 sm:h-48 overflow-hidden flex items-center justify-center transition-colors duration-300 ${
                      isDarkMode
                        ? 'bg-gradient-to-br from-gray-900/50 to-transparent border border-gray-800 group-hover:border-[var(--brand-blue)]/20'
                        : 'bg-gradient-to-br from-gray-100/50 to-transparent border border-gray-200 group-hover:border-[var(--brand-blue)]/20'
                    }`}>
                      {/* Custom Software Preview */}
                      {item.title === "Custom Software" ? (
                        <div className="flex gap-3 items-center">
                          <div className="h-10 w-10 rounded-full bg-[var(--brand-blue)] animate-ping"></div>
                      ...
                      item.title === "Digital Transformation" ? (
                        <div className="w-full">
                          ...
                          <div className={`w-full h-4 rounded-full relative overflow-hidden shadow-inner ${
                            ...
                            <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-[var(--brand-blue)] to-blue-400 animate-progressBar rounded-full"></div>
                          </div>
                          <p className="text-xs text-[var(--brand-blue)] mt-2 font-semibold">87% Complete</p>
                        </div>
                      ) : /* Consultancy Preview */
                      item.title === "Consultancy" ? (
                        <div className="flex flex-col gap-2 text-xs sm:text-sm w-full">
                          <div className="bg-[var(--brand-blue)]/20 text-[var(--brand-blue)] p-3 rounded-xl self-start max-w-[85%] border border-[var(--brand-blue)]/30 animate-slideInLeft">
                          ...
                          <div className="bg-[var(--brand-blue)]/20 text-[var(--brand-blue)] p-3 rounded-xl self-start max-w-[85%] border border-[var(--brand-blue)]/30 animate-slideInLeft animation-delay-300">
                            "Got it, let's plan."
                          </div>
                        </div>
                      ...
                      item.title === "Digital Marketing" ? (
                        <div className={`w-full text-left ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                          <h4 className="text-sm font-bold mb-3 text-[var(--brand-blue)]">
                            Analytics Dashboard
                          </h4>
                          <div className="space-y-3">
                            <div>
                              <div className={`mb-1 text-xs flex justify-between ${
                                ...
                                <span>Visitors</span>
                                <span className="font-bold text-[var(--brand-blue)]">12.4k</span>
                              </div>
                              <div className={`w-full h-2 rounded-full relative overflow-hidden ${
                                isDarkMode ? 'bg-gray-800' : 'bg-gray-200'
                              }`}>
                                <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-[var(--brand-blue)] to-blue-400 w-2/3 rounded-full animate-expandWidth" />
                              </div>
                            </div>
                            <div>
                              <div className={`mb-1 text-xs flex justify-between ${
                        ...
                        <div className="w-full text-center">
                          <div className="flex flex-col gap-3 items-center">
                            <div className="flex gap-2 sm:gap-3 items-center">
                              ...
                              <FaArrowRight className="text-[var(--brand-blue)] animate-pulse" />
                              <span className="px-3 py-2 bg-[var(--brand-blue)]/30 rounded-lg text-xs font-semibold animate-pulse border border-[var(--brand-blue)]/50">
                                AI Engine
                              </span>
                      ...
                      item.title === "Digital Branding" ? (
                        <div className="flex flex-col items-center w-full">
                          ...
                          <p className="text-[var(--brand-blue)] text-sm font-bold tracking-wide">
                      ...
                      item.code ? (
                        <div className="w-full h-full flex items-center justify-center">
                          <pre className="text-[var(--brand-blue)] text-xs sm:text-sm font-mono leading-relaxed whitespace-pre-wrap w-full">
                            {text}
                        ...
                        <Icon size={56} className="text-[var(--brand-blue)] animate-pulse-soft" />
                      )}
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3 sm:py-4 px-6 bg-gradient-to-r from-[var(--brand-blue)] to-[#0035CF] hover:from-[#0035CF] hover:to-[#0025AF] text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-[0_10px_40px_rgba(0,69,239,0.4)] flex items-center justify-center gap-2 group/btn"
                    >
                      <span>Read More</span>
          ...
          <div className={`swiper-button-prev-custom absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 backdrop-blur-sm rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 -ml-4 sm:-ml-6 hover:bg-[var(--brand-blue)] ${
            isDarkMode
              ? 'bg-gray-800/50 border border-gray-700 hover:border-[var(--brand-blue)]'
              : 'bg-gray-200/50 border border-gray-300 hover:border-[var(--brand-blue)]'
          }`}>
            <span className={isDarkMode ? 'text-white text-xl' : 'text-gray-900 text-xl'}>‹</span>
          </div>
          <div className={`swiper-button-next-custom absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 sm:w-12 sm:h-12 backdrop-blur-sm rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 -mr-4 sm:-mr-6 hover:bg-[var(--brand-blue)] ${
            isDarkMode
              ? 'bg-gray-800/50 border border-gray-700 hover:border-[var(--brand-blue)]'
              : 'bg-gray-200/50 border border-gray-300 hover:border-[var(--brand-blue)]'
          }`}>
